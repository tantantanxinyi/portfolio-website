        ...
        <div className="flex flex-col mt-10 gap-20 md:mt-20">
          {portfolioProjects.map(project => (
            <div
              ...
              after:outline-white/20 px-8 pt-8 md:pt-12 md:px-10 after:pointer-events-nonec"
            >
              <div
              ...
              <div
                ...
                tracking-widest text-sm text-transparent  
                bg-clip-text"
              >
              ...
              <ul className="flex-col flex gap-4 mt-4 md:mt-5 ">
